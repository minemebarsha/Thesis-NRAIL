\begin{abstract}
% checked
\noindent Satisfiability Modulo Theories (SMT) solving is a technology for checking the satisfiability of the first-order logic formulas over some theories.
